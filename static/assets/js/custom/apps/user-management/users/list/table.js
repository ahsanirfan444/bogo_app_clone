...
var KTUsersList2 = function() {
    var e, t, n, r, o = document.getElementById("kt_table_vendors"), c = ()=>{
        o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t=>{
            t.addEventListener("click", (function(t) {
                t.preventDefault();
                const n = t.target.closest("tr")
    ...
    return {
        init: function() {
            ...
            l(),
            document.querySelector('[data-kt-user-table-filter="search_vendors"]').addEventListener("keyup", (function(t) {
                e.search(t.target.value).draw()
            }
            )),
            // document.querySelector('[data-kt-user-table-filter="reset"]').addEventListener("click", (function() {
