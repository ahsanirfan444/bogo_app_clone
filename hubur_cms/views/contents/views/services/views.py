...
class VendorServicesList(AuthBaseViews):
    ...
    def get(self, request, *args, **kwargs):
        ...
        images_list = [models.Images.objects.filter(i_content=data, type=3) for data in services]
...
class VendorCreateServices(AuthBaseViews):
    TEMPLATE_NAME = "contents/services/create_services.html"
        ...
        try:
            if form.is_valid():
                ...
                if product_form.is_valid():
                    ...
                    product_instance.content_type = 2
...
class VendorEditServices(AuthBaseViews):
    TEMPLATE_NAME = "contents/services/edit_services.html"
        ...
        try:
            if form.is_valid():
                ...
                if product_form.is_valid():
                    ...
                    delete_content_images(image_ids, request.user, 3, self.get_vendor_business())
...
class VendorDeleteServices(DeleteView, AuthBaseViews):
    template_name = "contents/services/confirm_delete_services.html"
    model = models.Content

    def get_success_url(self):
        return reverse_lazy("list_vendor_services")
    
    def get_context_data(self, **kwargs):
        kwargs.update(self.get_default_context())
        kwargs.update({"RETURN_URL": reverse_lazy("list_vendor_services")})
